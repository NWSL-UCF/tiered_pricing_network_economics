...
output_path_png = os.path.join(base_dir, 'consumer_surplus_heatmaps_s0_individual.png')
output_path_pdf = os.path.join(base_dir, 'consumer_surplus_heatmaps_s0_individual.pdf')
...
print("\nConsumer Surplus ranges for each s₀:")
print("-" * 60)
