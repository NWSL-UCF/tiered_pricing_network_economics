...
output_path_png = os.path.join(base_dir, 'welfare_for_different_alpha.png')
output_path_pdf = os.path.join(base_dir, 'welfare_for_different_alpha.pdf')
...
print("\nSocial Welfare ranges for each alpha:")
print("-" * 80)
for data in heatmap_data:
    vmin = data['matrix'].min()
    vmax = data['matrix'].max()
    print(f"α={data['alpha']:.2f}: min={vmin:.12f}, max={vmax:.12f}, range={vmax-vmin:.12f}")
