...
output_path_png = os.path.join(base_dir, 'welfare_for_different_s0.png')
output_path_pdf = os.path.join(base_dir, 'welfare_for_different_s0.pdf')
...
print("\nSocial Welfare ranges for each s₀:")
print("-" * 80)
for data in heatmap_data:
    vmin = data['matrix'].min()
    vmax = data['matrix'].max()
    print(f"s₀={data['s0']:.2f}: min={vmin:.12f}, max={vmax:.12f}, range={vmax-vmin:.12f}")
